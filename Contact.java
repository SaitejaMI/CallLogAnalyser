...
public class Contact {
    ...
    private int incomingDuration=0, outgoingDuration=0, totalDuration=0, longestDuration=0;
    private int numberOfOutgoingCalls=0, numberOfIncomingCalls=0, numberOfTotalCalls=0, numberOfMissedCalls=0;
    private int averageDuration=0, numberOfAverageCalls=0;
    ...
    public int getAverageDuration(){ return totalDuration/numberOfTotalCalls;}

    public int getNumberOfAverageCalls(int days){ return numberOfTotalCalls/days;}
}
